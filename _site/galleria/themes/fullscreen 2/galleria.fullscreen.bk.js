...
Galleria.addTheme({
    ...
    init: function(options) {
        ...
        this.addElement('galleria-thumbnails-tab');
        this.appendChild('galleria-thumbnails-container','galleria-thumbnails-tab');
        
        var tab = this.$('galleria-thumbnails-tab');
        var loader = this.$('galleria-loader');
        var thumbs = this.$('galleria-thumbnails-container');
        var list = this.$('galleria-thumbnails-list');
        var infotext = this.$('galleria-info-text');
        var info = this.$('galleria-info');
